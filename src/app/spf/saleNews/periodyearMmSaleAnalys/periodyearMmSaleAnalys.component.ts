...
import { PeriodyearMmSaleAnalys } 		from './shared/periodyearMmSaleAnalys.model';
import { PeriodyearMmSaleAnalysService } from './shared/periodyearMmSaleAnalys.service';
import { EnvService } from '../../../shared/env.service';
import { HttpErrorResponse } from '@angular/common/http';

@Component({
	selector: 'app-periodyearMmSaleAnalys',
	templateUrl: './periodyearMmSaleAnalys.component.html',
	providers: [PeriodyearMmSaleAnalysService],
})
export class PeriodyearMmSaleAnalysComponent implements OnInit {
	...
	//param model
	public paramModel: PeriodyearMmSaleAnalys = <PeriodyearMmSaleAnalys>{};

	//grid select model
	public gridModel: PeriodyearMmSaleAnalys = <PeriodyearMmSaleAnalys>{};

   	//점
   	public comboStoreLv1: any = null;
   	public comboStoreLv1Model: PeriodyearMmSaleAnalys = <PeriodyearMmSaleAnalys>{};

   	//부
   	public comboStoreLv2: any = null;
   	public comboStoreLv2Model: PeriodyearMmSaleAnalys = <PeriodyearMmSaleAnalys>{};

   	//팀
   	public comboStoreLv3: any = null;
   	public comboStoreLv3Model: PeriodyearMmSaleAnalys = <PeriodyearMmSaleAnalys>{};
	...
	constructor(private periodyearMmSaleAnalysService: PeriodyearMmSaleAnalysService, public envService: EnvService ) { }
	ngOnInit() { 
		//시작일자---
	...
	onTapQuery(event){
		...
		this.periodyearMmSaleAnalysService.selectPeriodyearMmSaleAnalysList(this.paramModel).subscribe(
			(res: any) => {
				console.log(res);
				/**
				 * @success
	...
	onTapDelete(event){
		Ext.Msg.confirm("삭제", "데이터를 삭제합니다", 
			function(){
				this.periodyearMmSaleAnalysService.deletePeriodyearMmSaleAnalys(null).subscribe(
					(res: any) => {
						/**
						 * @success
						 */
	...
	onTapSave(event){
		Ext.Msg.confirm("저장", "데이터를 저장합니다", 
			function(){
				this.periodyearMmSaleAnalysService.savePeriodyearMmSaleAnalys(null).subscribe(
					(res: any) => {
						/**
						 * @success
						 */
	...
	// //엑셀 버튼 이벤트
	onTapExcel(event){
		let url = this.periodyearMmSaleAnalysService.excelPeriodyearMmSaleAnalys(this.paramModel);
		console.log(url);
	...
	onTapPdfQuery(event){
		...
		this.pdfUrl = this.periodyearMmSaleAnalysService.reportPeriodyearMmSaleAnalys(this.paramModel);
	...
	//도움말 버튼 이벤트
	onTapHelp(event){
		this.periodyearMmSaleAnalysService.helpPeriodyearMmSaleAnalys(this.paramModel).subscribe(
			(res: any) => {
				/**
				 * @success
				 */
